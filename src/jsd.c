...
bool jsd_init_single_device(jsd_t* self, uint16_t slave_id) {
  ...
  switch (slave->eep_id) {
    ...
    case JSD_EL3004_PRODUCT_CODE: {
      return jsd_el3004_init(self, slave_id);
      break;
    }
    case JSD_EL3054_PRODUCT_CODE: {
      return jsd_el3054_init(self, slave_id);
      break;
    }
    ...
    case JSD_EL4034_PRODUCT_CODE: {
      return jsd_el4034_init(self, slave_id);
      break;
    }
